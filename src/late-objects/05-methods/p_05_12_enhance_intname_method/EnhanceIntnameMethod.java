package p_05_12_enhance_intname_method;

import java.util.Scanner;

/**
 * Enhance the {@code intName} method so that it works correctly for negative
 * values and zero. Caution: Make sure the improved method doesn't print 20 as
 * "twenty zero".
 */
public class EnhanceIntnameMethod
{
    public static void main(String[] args)
    {
        ...
        System.out.print(negativeOrPositive(input));
    }
    ...
    /**
     * The method converts integer to positive if n < 0, passes n value to
     * the {@code intName} method and returns it with String "minus". If an
     * integer > 0 the method passes n to the intName method and returns it.
     *
     * @param n integer
     * @return String
     */
