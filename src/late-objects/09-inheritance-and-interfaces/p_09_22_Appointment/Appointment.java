...
/**
 * Improve the appointment book program of Exercise P9.21. Give the user the
 * option to add new appointments. The user must specify the type of the
 * appointment, the description, and the date.
 */
